...
<head>
    ...
    <title>Tambah Penjualan - 2NF Praktikum</title>
                    ...
                    <div class="card-body">
                        <form action="{{ route('sales.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('id_penjualan') is-invalid @enderror" id="id_penjualan" name="id_penjualan" value="{{ old('id_penjualan') }}" required>
                                @error('id_penjualan')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('harga_satuan') is-invalid @enderror" id="harga_satuan" name="harga_satuan" value="{{ old('harga_satuan') }}" min="0" step="0.01" required>
                                @error('harga_satuan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('total') is-invalid @enderror" id="total" name="total" value="{{ old('total') }}" min="0" step="0.01" required>
                                @error('total')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
