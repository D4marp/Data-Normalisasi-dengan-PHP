...
<head>
    ...
    <title>Manajemen Produk - 1NF Praktikum</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1>Manajemen Produk - 1NF Praktikum</h1>
        ...
        <div class="mt-4">
            <a href="{{ route('normalization.firstNF') }}" class="btn btn-secondary">Kembali ke Teori 1NF</a>
        </div>
    </div>
